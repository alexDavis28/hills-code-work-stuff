...
namespace DastanTesting
{
    class Program
    {
        static void Main(string[] args)
        {
            Dastan ThisGame = new Dastan(10, 10, 4);
            ThisGame.PlayGame();
    ...
    class Dastan
    {
        ...
        public Dastan(int R, int C, int NoOfPieces)
        {
            ...
            CurrentPlayer.ChangeScore(40);
            Console.WriteLine(Players[0].GetScore());
            Console.WriteLine(CurrentPlayer.GetScore());
        }
        ...
        private void CreateCustomPlayers()
        {
            ...
            Players.Add(new Player(PlayerOneName, 1));
        ...
        public void PlayGame()
        {
            ...
            while (!GameOver)
            {
                ...
                do
                {
                    ...
                    Console.WriteLine("8 to spy on opponent's queue");
                    ...
                    else if (Choice == 8)
                    {
                        ...
                        {
                            Console.WriteLine(Players[1].GetJustQueueAsString());
                        }
                        else
                        {
                            Console.WriteLine(Players[1].GetJustQueueAsString());
